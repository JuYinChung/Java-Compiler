...
public class ParserTest {
	...
	public void testSmallest() throws LexicalException, SyntaxException {
		String input = "prog{image var1; red( var1[1,0.0]) := 5;}";  
		Parser parser = makeParser(input);
		Program p = parser.parse();
		show(p);
	...
	public void testDec0() throws LexicalException, SyntaxException {
		...
		//System.out.print("##"+p.block.toString());
	...
	@Test
	public void bool() throws LexicalException, SyntaxException {
		String input = "a{a:=(a==b?1:2);}";
		Parser parser = makeParser(input);
		Program p = parser.parse();
		show(p);	
